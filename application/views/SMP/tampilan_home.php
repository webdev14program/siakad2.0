<div class="row">
    <div class="col-md">
        <div class="card bg-primary">
            <div class="card-body">
                <h5 class="text-white font-weight-bold text-uppercase">siakad V2.0 perguruan tunas harapan swadharma (Kurikulum smp)</h5>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <table class="table table-border">
                    <tbody>
                        <tr>
                            <td>Nama Sekolah </td>
                            <td class="text-uppercase">: SMP Tunas Harapan</td>
                        </tr>
                        <tr>
                            <td>NPSN </td>
                            <td>: 20106898</td>
                        ...
                        <tr>
                            <td>Email </td>
                            <td>: tunasharapan.jhs@gmail.com</td>
                        </tr>
