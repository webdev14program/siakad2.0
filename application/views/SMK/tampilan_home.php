<div class="row">
    <div class="col-md">
        <div class="card bg-primary">
            <div class="card-body">
                <h5 class="text-white font-weight-bold text-uppercase">siakad V2.0 perguruan tunas harapan swadharma (Kurikulum smk)</h5>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-md">
        <div class="card bg-danger">
            <div class="card-body">
                ...
                <h5 class="text-center text-uppercase text-white font-weight-bold"><?= $siswa_smk ?> siswa </h5>
            </div>
        </div>
    </div>
    <div class="col-md">
        <div class="card bg-success">
            <div class="card-body">
                <h5 class="text-center text-uppercase text-white font-weight-bold">jurusan</h5>
                <h5 class="text-center text-uppercase text-white font-weight-bold"><?= $jurusan_smk ?> jurusan </h5>
            </div>
        </div>
    </div>
    ...
    <div class="col-md">
        <div class="card bg-warning">
            <div class="card-body">
                ...
                <h5 class="text-center text-uppercase text-white font-weight-bold"><?= $kelas_smk ?> Kelas</h5>
            </div>
        </div>
    </div>
</div>
