                        ...
                        <tbody>
                            <tr>
                                ...
                                ?>
                                    ...
                                    <td class="text-center"><a class="btn btn-primary btn-sm " href="<?= base_url() ?>Dashboard/detail_absen_guru_perbulan/<?= $row['bulan_tahun'] ?>"><i class="fas fa-search"></i> Detail</a></td>
