                        ...
                        <tbody>
                            <tr>
                                ...
                                ?>
                                    ...
                                    <td class="text-center text-uppercase"><a class="btn btn-primary btn-sm" href="<?= base_url() ?>Dashboard_sd/data_absen_guru_perhari/<?= $row['bulan_tahun'] ?>"><i class="fas fa-search"></i> details</a></td>
